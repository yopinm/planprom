...
| **Production** | Live · https://couponkum.com · VPS `root@103.52.109.85` |
| **Branch** | `develop` → push → deploy VPS ทุกครั้ง |
...
| **Doc Sync** | task เสร็จ → อัพเดต PRD.md + `core/Coupon_TP.MD` เสมอ |
...
| Item | Value |
|---|---|
| Product | Couponkum.com |
| Slogan | **คุ้มทุกการใช้จ่าย · ง่ายทุกการวางแผน** |
| Mode | **Post-Launch / V15 Template + Coupon** |
| Production | **Live since 2026-05-01** — VPS + PM2 + Nginx + Cloudflare Full (Strict) |
| Goal now | V15 Template + Coupon — auto-harvest coupons (AT/IA), calculator, vertical expansion, LINE OA daily digest |
| Progress | **149 / 151 V13 done · V15 series opened 2026-05-07** |
| Branch | `develop` |
| VPS | root@103.52.109.85 · /var/www/couponkum |
...
# server-with-env.js โหลด .env.local อัตโนมัติเมื่อ PM2 start/reload
