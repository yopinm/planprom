            ...
            <div className="mt-6 overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-sm">
              <div className="grid grid-cols-3 divide-x divide-neutral-100">
                ...
                <div className="relative flex flex-col items-center bg-emerald-50 px-3 py-4">
                  ...
                  <span className="absolute right-1.5 top-1.5 rounded-full bg-emerald-500 px-1.5 py-0.5 text-[9px] font-black text-white">-33%</span>
                  <p className="text-[10px] font-black uppercase tracking-wider text-emerald-600">ประหยัด</p>
