...
.if-line{flex:1;border-bottom:1.5px solid #1a1a1a;min-width:40px;height:22px;align-self:flex-end}
.if-fixed{border-bottom:1.5px solid #1a1a1a;height:22px;flex-shrink:0;align-self:flex-end}
