...
.hdr{border-bottom:3px solid #1a1a1a;padding-bottom:10px;margin-bottom:16px}
.hdr-title{font-size:15pt;font-weight:700;color:#1a1a1a}
.hdr-meta{display:flex;gap:20px;margin-top:5px;font-size:9pt;color:#6b7280}
.hdr-badge{background:#ffffff;color:#1a1a1a;font-size:8pt;font-weight:700;padding:2px 8px;border-radius:99px;border:1px solid #374151}
...
.field-label{font-size:8pt;font-weight:700;color:#374151;text-transform:uppercase;letter-spacing:.05em;margin-bottom:3px}
...
.blank-line{border-bottom:1.5px solid #1a1a1a;height:26px;margin-bottom:4px}
...
.sig-box{border:1px dashed #374151;border-radius:4px;padding:8px;height:60px;display:flex;flex-direction:column;justify-content:flex-end}
...
table.data-table td{padding:5px 8px;border-bottom:1px solid #e5e7eb;min-height:24px}
table.data-table tr:nth-child(even) td{background:#fafafa}
.page2-banner{background:#f3f4f6;border:1.5px solid #374151;border-radius:6px;padding:8px 14px;margin-bottom:14px;font-size:9pt;color:#1a1a1a;font-weight:700}
