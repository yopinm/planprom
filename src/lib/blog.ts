...
export const AUTHORS: Record<string, BlogAuthor> = {
  couponkum_team: {
    ...
    bio: 'ทีมงานคูปองคุ้มคัดสรรเทมเพลต PDF และแพลนเนอร์คุณภาพสูง พร้อมใช้งานทันที เหมาะสำหรับธุรกิจ การเงิน และชีวิตประจำวัน',
  },
}
...
คูปองคุ้มมีเทมเพลต PDF กรอกได้ในหมวด [ธุรกิจ / เปิดร้าน](/catalog/business) ราคาเริ่มต้น ฿20 ดาวน์โหลดได้ทันทีหลังชำระเงิน ใช้ซ้ำได้ไม่จำกัด`
...
คูปองคุ้มมีแพลนเนอร์งบประมาณ PDF กรอกได้ในหมวด [การเงิน](/catalog/finance) ราคา ฿20 ดาวน์โหลดทันที ใช้ซ้ำได้ทุกเดือน`
